...
information about how commands work can be found in the documentation for [Commands](Commands.md).
...
- **key:** *charcreate*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:pperm(Player)"*
...
- **key:** *ban*
- **aliases:** *bans*
- **[locks](Locks.md):** *"cmd:perm(ban) or perm(Developer)"*
...
- **key:** *boot*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(boot) or perm(Admin)"*
- **[`help_category`](Help-System):** *"Admin"*
...
- **key:** *emit*
- **aliases:** *pemit*, *remit*
- **[locks](Locks.md):** *"cmd:perm(emit) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Admin"*
...
- **key:** *force*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(spawn) or perm(Builder)"*
...
- **key:** *perm*
- **aliases:** *setperm*
- **[locks](Locks.md):** *"cmd:perm(perm) or perm(Developer)"*
- **[`help_category`](Help-System):** *"Admin"*
...
- **key:** *unban*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(unban) or perm(Developer)"*
- **[`help_category`](Help-System):** *"Admin"*
...
- **key:** *userpassword*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(newpassword) or perm(Admin)"*
- **[`help_category`](Help-System):** *"Admin"*
...
- **key:** *wall*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(wall) or perm(Admin)"*
- **[`help_category`](Help-System):** *"Admin"*
...
- **[locks](Locks.md):** *"cmd:perm(batchcommands) or perm(Developer)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *alias*
- **aliases:** *setobjalias*
- **[locks](Locks.md):** *"cmd:perm(setobjalias) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *cmdsets*
- **aliases:** *listcmsets*
- **[locks](Locks.md):** *"cmd:perm(listcmdsets) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *copy*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(copy) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *cpattr*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(cpattr) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *create*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(create) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *desc*
- **aliases:** *describe*
- **[locks](Locks.md):** *"cmd:perm(desc) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *destroy*
- **aliases:** *del*, *delete*
- **[locks](Locks.md):** *"cmd:perm(destroy) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *dig*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(dig) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *examine*
- **aliases:** *exam*, *ex*
- **[locks](Locks.md):** *"cmd:perm(examine) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **[locks](Locks.md):** *"cmd:perm(find) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *link*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(link) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *lock*
- **aliases:** *locks*
- **[locks](Locks.md):** *"cmd: perm(locks) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *mvattr*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(mvattr) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *name*
- **aliases:** *rename*
- **[locks](Locks.md):** *"cmd:perm(rename) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *open*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(open) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *script*
- **aliases:** *addscript*
- **[locks](Locks.md):** *"cmd:perm(script) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *set*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(set) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *sethome*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(sethome) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *tag*
- **aliases:** *tags*
- **[locks](Locks.md):** *"cmd:perm(tag) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *tel*
- **aliases:** *teleport*
- **[locks](Locks.md):** *"cmd:perm(teleport) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *tunnel*
- **aliases:** *tun*
- **[locks](Locks.md):** *"cmd: perm(tunnel) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **[locks](Locks.md):** *"cmd:perm(typeclass) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *unlink*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(unlink) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **key:** *wipe*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(wipe) or perm(Builder)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **[locks](Locks.md):** *"cmd:not pperm(channel_banned)"*
...
- **[locks](Locks.md):** *"cmd:not pperm(channel_banned) and pperm(Player)"*
- **[`help_category`](Help-System):** *"Comms"*
...
- **[locks](Locks.md):** *"cmd:not perm(channel_banned)"*
- **[`help_category`](Help-System):** *"Comms"*
...
- **key:** *irc2chan*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:serversetting(IRC_ENABLED) and pperm(Developer)"*
- **[`help_category`](Help-System):** *"Comms"*
...
- **key:** *page*
- **aliases:** *tell*
- **[locks](Locks.md):** *"cmd:not pperm(page_banned)"*
- **[`help_category`](Help-System):** *"Comms"*
...
- **key:** *rss2chan*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:serversetting(RSS_ENABLED) and pperm(Developer)"*
- **[`help_category`](Help-System):** *"Comms"*
...
- **key:** *home*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(home) or perm(Builder)"*
- **[`help_category`](Help-System):** *"General"*
...
- **key:** *sethelp*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(Helper)"*
- **[`help_category`](Help-System):** *"Building"*
...
- **[locks](Locks.md):** *"cmd:perm(listobjects) or perm(Builder)"*
- **[`help_category`](Help-System):** *"System"*
...
- **key:** *py*
- **aliases:** *!*
- **[locks](Locks.md):** *"cmd:perm(py) or perm(Developer)"*
- **[`help_category`](Help-System):** *"System"*
...
- **key:** *reload*
- **aliases:** *restart*
- **[locks](Locks.md):** *"cmd:perm(reload) or perm(Developer)"*
- **[`help_category`](Help-System):** *"System"*
...
- **[locks](Locks.md):** *"cmd:perm(listscripts) or perm(Admin)"*
- **[`help_category`](Help-System):** *"System"*
...
- **[locks](Locks.md):** *"cmd:perm(list) or perm(Developer)"*
- **[`help_category`](Help-System):** *"System"*
...
- **key:** *service*
- **aliases:** *services*
- **[locks](Locks.md):** *"cmd:perm(service) or perm(Developer)"*
- **[`help_category`](Help-System):** *"System"*
...
- **key:** *shutdown*
- **aliases:** 
- **[locks](Locks.md):** *"cmd:perm(shutdown) or perm(Developer)"*
- **[`help_category`](Help-System):** *"System"*
...
- **key:** *time*
- **aliases:** *uptime*
- **[locks](Locks.md):** *"cmd:perm(time) or perm(Player)"*
- **[`help_category`](Help-System):** *"System"*
